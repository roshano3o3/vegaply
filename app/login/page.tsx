        ...
        <div className="auth-left">
          ...
          <div className="auth-hero">
            ...
            <h1 className="auth-headline">
              Land your<br />
              dream job <em>faster</em><br />
              than anyone else.
            </h1>
            <p className="auth-sub">
              ApplySmart finds freshly posted roles before the crowd arrives — then tailors your resume, preps your interview, and tracks every application automatically.
            </p>
            <div className="auth-stats">
              <div>
                <div className="auth-stat-num">⚡ 6h</div>
                <div className="auth-stat-label">Early bird advantage</div>
              </div>
              <div>
                <div className="auth-stat-num">3×</div>
                <div className="auth-stat-label">More interviews</div>
              </div>
              <div>
                <div className="auth-stat-num">AI</div>
                <div className="auth-stat-label">Resume matching</div>
              </div>
            </div>
          </div>
          ...
          <div className="auth-ticker">
            ...
            <div className="ticker-cards">
              <div className="ticker-card">
                <div className="ticker-dot green" />
                <div className="ticker-text">Senior UX Designer posted at Figma</div>
                <div className="ticker-time">2m ago</div>
              </div>
              <div className="ticker-card">
                <div className="ticker-dot blue" />
                <div className="ticker-text">Data Analyst role at Stripe — 0 applicants</div>
                <div className="ticker-time">11m ago</div>
              </div>
              <div className="ticker-card">
                <div className="ticker-dot pink" />
                <div className="ticker-text">PM opening at OpenAI, remote</div>
                <div className="ticker-time">34m ago</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <button className="form-btn" onClick={handleLogin} disabled={loading}>
              {loading ? (
                <span className="form-loading">
                  <span className="form-spinner" /> Signing in…
                </span>
              ) : "Sign In →"}
            </button>
