...
function JobCard({ job, saved, onToggleSave, onClick, onTailor, onInterview, earlyBirdMode, resumeReady, isTracked, onTrack }: {
  job: JobWithMatch;saved:boolean;onToggleSave:()=>void;onClick:()=>void;onTailor:()=>void;onInterview:()=>void;earlyBirdMode:boolean;resumeReady:boolean;isTracked:boolean;onTrack:()=>void;
}) {
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .card-btn{flex:1;border-radius:8px;padding:7px 8px;font-size:11px;font-weight:600;font-family:inherit;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:4px;border:1px solid;transition:all .2s}
      ...
      <div className="main-layout">
        <aside className="sidebar">
          ...
          <div className="sidebar-card">
            ...
            <ResumePanel resumeText={resumeText} fileName={resumeFileName} onResume={(t,n)=>{setResumeText(t);setResumeFileName(n);}} onClear={()=>{setResumeText("");setResumeFileName("");}}/>
            ...
            {resumeText&&earlyBirdJobs.length===0&&<p style={{fontSize:11,color:"rgba(255,255,255,0.2)",marginTop:10,textAlign:"center"}}>Run ⚡ Early Bird first!</p>}
          </div>
